    ...
    <div className="a">
      <div className="a-left">
        ...
        <div className="a-card">
          ...
          <Progress skill="Html" done="95" />
          <Progress skill="CSS" done="85" />
          <Progress skill="Javascript" done="80" />
          <Progress skill="Design" done="75" />
          <Progress skill="Database" done="75" />
        </div>
      </div>
      <div className="a-right">
        <h1 className="a-title">About Me</h1>
        <p className="a-sub">
          As a web developer at the University of Colorado Denver, I bring a
          wealth of experience from my previous role as an IT Professional. My
          enthusiasm for continuous learning extends to all things technology,
          with a particular focus on web technologies. Crafting websites and web
          applications is not just a job for me; it's a passion. I take pride in
          the knowledge that my work contributes to making a positive impact and
          helps people in meaningful ways.
        </p>
        <p className="a-desc">
